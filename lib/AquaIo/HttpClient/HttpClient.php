...
use AquaIo\HttpClient\AuthHandler;
use AquaIo\HttpClient\ErrorHandler;
use AquaIo\HttpClient\RequestHandler;
use AquaIo\HttpClient\Response;
use AquaIo\HttpClient\ResponseHandler;
